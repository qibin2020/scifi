...
def build_driver_cmd(task_name, extra_args):
    ...
    env = {
        ...
        # Driver tuning knobs — only forwarded when set in ENV.sh.
        # Defaults live in driver.py; uncomment in ENV.sh to override.
        **{k: v for k, v in {
            ...
            "CHECKPOINT_EVERY":           _env_opt("CHECKPOINT_EVERY"),
