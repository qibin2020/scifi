...
# Pattern: N nodes × 4 GPUs — regular QOS (1 GPU visible per task)
# Use for: large-scale DDP training across multiple nodes
# Generated: {{DATE}}
...
echo "GPUs:      $(({{NUM_NODES}} * 4)) (4 per node × {{NUM_NODES}} nodes)"
echo "Start:     $(date)"
